...
from profiles.views import CustomPasswordResetView

handler404 = 'videos.views.handler500'

urlpatterns = [
    path('eb16f4a593b6fccbc1c8c92a53e2152ce738d9de251f8d60fdbb88789390e17a/', admin.site.urls),
